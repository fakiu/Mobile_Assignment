...
public class SignUpActivity extends AppCompatActivity {
    ...
    public void saveRecord(View v) {
        ...
        try {
            ...
            makeServiceCall(this, "https://sports-tify.000webhostapp.com/insert_login.php", login);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void makeServiceCall(Context context, String url, final LoginInformation login) {
